            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <form action="{{route("add_to_cart", ["product"=>$product->id])}}" method="get" class="d-inline-block">
                            <div class="product__details__quantity">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <input name="buy_quantity" max="{{$product->quantity}}" type="number" value="1">
                                    </div>
                                </div>
                            </div>
                        ...
                        <ul>
                            <li><b>Availability</b> @if($product->quantity >0)<span style="color:#288628;">In Stock</span>
                                @else <span style="color:#9a0f0f;">Out Stock</span> @endif
                            </li>
