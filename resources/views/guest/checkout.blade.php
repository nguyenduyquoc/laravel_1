                        ...
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Phone<span>*</span></p>
                                        <input name="customer_tel" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                            ...
                            <div class="checkout__order">
                                ...
                                <ul>
                                    @foreach($cart as $item)
                                        <li style="font-weight: bold; font-style: inherit"> {{$item->name}} (*{{$item->buy_quantity}}) <span>{{number_format($item->price)}}</span></li>
                                    @endforeach
                                </ul>
                                ...
                                <div class="checkout__input__checkbox">
                                    <label for="paypal">
                                        Paypal
                                        <input name="payment" value="paypal" type="checkbox" id="paypal">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
